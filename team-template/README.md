...
- **ชื่อทีม:** sasnu01
- **เลขทีม:** XX
- **ชื่อบอร์ด:** aduino Uno Q
- **สมาชิก + บทบาท (3H):**
  - 🛠️ **Hacker** (เทคนิค: ต่อบอร์ด/เก็บ data/train/deploy): อามีรู แวเงาะ
  - 🎨 **Hipster** (ผู้ใช้: output ที่คนเข้าใจ/รูปแบบใช้งาน): อุมมูรูมาน ดาโอะ
  - 📣 **Hustler** (คุณค่า: ปัญหา/ผู้ใช้/เล่าเดโม่): ชีรีน ดอเลาะ
