...
|---|---|---|
| 1. Modulino sensor (Qwiic) | [ ✅️ ] | ![sensor](../assets/sensor.jpg) |
| 2. USB Webcam | [ ✅️ ] | ![camera](../assets/camera.jpg) |
| 3. USB Mic | [ ✅️ ] | ![mic](../assets/mic.jpg) |

## Modulino — ลองกี่ตัว (มี 7 ตัว)

ลองให้ครบเผื่อไอเดีย แล้วติ๊กตัวที่ลองแล้วได้ ([ตัวอย่างโค้ด 7 ตัว](../../student/examples/modulino/)):

- [ ✅️ ] Movement  - [ ] Distance  - [ ] Thermo  - [ ] Buttons  - [ ] Knob  - [ ] Pixels  - [ ] Buzzer

**ตัวที่ค่าแยกสถานการณ์ได้ชัดสุด (น่าเอาไปเทรนบ่าย):** _______________

## Challenge (ถ้าทำ)

- [ ✅️ ] A — Proximity Alarm (sensor → buzzer)
- [ ✅️ ] B — เก็บ Movement เป็น CSV ไว้เทรนบ่าย (ไฟล์อยู่ที่: _______________)
